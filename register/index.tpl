					...
					<li id="li_3" >
						...
						<div>
							<input id="element_3" name="email" class="element text medium" type="text" maxlength="255" value="<?smarty $form.email|default:"" ?>"/>
                                        ...
                                        <?smarty if $smarty.const.SHOW_PHONEFIELD_IN_REGISTERFORM ?>
                                        <li id="li_5" >
						<label class="description" for="element_5">Phone </label>
						<div>
							<input id="element_1" name="phone" class="element text medium" type="text" maxlength="255" value="<?smarty $form.phone|default:"" ?>"/>
						</div>
					</li>
                                        <?smarty /if ?>
					<li>
