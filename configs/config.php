...
//ini_set("error_log", FULLCAL_DIR . "/php-error.log");
...
define('SHOW_AGENDA_VIEW_BUTTON', true);    // listview
...
define('FIRSTDAY_OF_WEEK', 0);  // The day that each week begins. (0 = sunday, 1 = monday etc.)
...
define('MAIL_EVENT_MAILBODY', 'Employee: %FIRSTNAME% %INFIX% %LASTNAME%<br />'
        . 'Title: %TITLE% (%CALENDARNAME%<br />'
        . '%DROPDOWN1% - %DROPDOWN2%<br />'
        . '<p>Description: %DESCRIPTION%</p><br />'
        . 'Location: %LOCATION%<br />'
        . 'Phone: %PHONE%<br />'
        . 'Url: %URL%<br />');  // startdate and enddate are added in the email function
...
define('SORT_ALL_CALENDARS_BY_CAL_ORDERID', false);  // if true, when clicked on 'Show all', the events are sorted by orderID
...
define('SHOW_CALENDAR_NAME_IN_LISTVIEW', false);

define('COMBINE_MOREDAYS_EVENTS', true);   // custom listview
define('SHOW_ICON_FOR_MOREDAYS_EVENTS_IN_CUSTOM_LISTVIEW', false);
define('TRUNCATE_TITLE_IN_CUSTOM_LISTVIEW', false);
define('USERS_SORTING', 'firstname');    // user_id, firstname or lastname

define('ADMINS_GET_NOTIFICATION_POPUPS', true);
define('USERS_GET_NOTIFICATION_POPUPS', true);
define('CHECK_FOR_NOTIFICATIONS_EVERY', 30000);    // // not less than 5000 ! - 10000 is every 10 sec.

define('ACTION_ON_CLICK_EVENT_IN_CUSTOM_LISTVIEW', '4');     
// 1. simple_edit dialog, 
// 2. go to monthview and emphasize the event, 
// 3. go to monthview, emphasize the event and open edit dialog
// 4. goto monthview in new tab, emphasize and open edit dialog and close tab after update or close edit dialog
...
define('EVENT_TEXT_COLOR', 'white');  // white or black or colorcode like #FFFFFF, if white or black the icon is also white or black
...
define('HIDE_MINUTES_IN_MONTH_WEEK_DAY_VIEW', false);  
define('HIDE_PDF_BUTTON', false);
define('HIDE_PRINT_BUTTON', false);
define('CUSTOM_LISTVIEW_IS_DEFAULT_VIEW_FOR_USERS_AND_NOT_LOGGEDIN_VIEWERS', false);
define('USERS_CAN_ONLY_CHANGE_TITLE', false);

define('SLOT_MINUTES', 30); // The frequency for displaying time slots, in minutes
define('SNAP_MINUTES', 30); // The time interval at which a dragged event will snap to the agenda view time grid. Also affects the granularity at which selections can be made. Specified in number of minutes
define('SLOT_EVENT_OVERLAP', true); // Determines if timed events in agenda view should visually overlap.

define('SHOW_AVAILABLE_EMPLOYEES_ROW', false);   // true of false - if you want to show the row with the amount of availble employees for each day
define('AVAILABLE_EMPLOYEES_ROW_LABEL', 'employees');
define('AVAILABLE_EMPLOYEES_DROPDOWN_EMPTYTEXT', 'Select employees');
define('AVAILABLE_EMPLOYEES_GROUP', 3); // the ID of the usergroup of which you want to show the available amount

define('SHOW_CALENDAR_NAME_IN_CUSTOM_LISTVIEW', false);  // to show or hide the calendarname in the custom listview

define('SHOW_PHONEFIELD_IN_REGISTERFORM', false);

define('DAYDATE_IN_MONTHVIEW_FORMAT', 'd');  // default 'd', but you can do what you want, e.g. 'dddd dd-MM'
define('CAL_BLOCK_FIXED_POSITION', false);
define('HIDE_CSV_BUTTON', false);
define('HIDE_ICS_BUTTON', false);   // ics export is work in progress

define('REFRESH_ICON_WHITE', true);  // true or false
define('ASSIGNED_ICON_WHITE', true); // true or false
define('BOOTSTRAP_LOGIN', true);
define('SHOW_LOGO_IN_LOGIN_FORM',true);
