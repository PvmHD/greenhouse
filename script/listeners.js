...
//    });
    ...
    $('#go_to_custom_listview_btn').click(function() {
        window.location = MyCalendar.FULLCAL_URL+'/?action=agenda&cid='+MyCalendar.currentCalendars;
    ...
    $('#reset_user_filter_btn').click(function() {
        ...
        $('#user_filter_selectbox').pqSelect("refreshData");
...
//            if ($('#event_edit_dlg_event_start_end_text').is(':empty')){
//                // do not show
//            } else {
...
//            }
     ...
     //TODO       $('#recurring_dates_div').show();
     //TODO       $('#datepicker_startdate').appendTo('#event_edit_dlg_pattern_startdate');
