...
Lang.Popup.LabelSalutation = 'Yrkestittel';
...
Lang.Settings.Infotext = 'Noen av disse innstillingene vil kun bli brukt når noen er logget inn, ellers innstillingene fra config.php vil bli brukt.';
...
Lang.Calendar.LabelUseColorForAllEvents = 'Bruk aktuell bakgrunnsfarge for alle hendelsene i denne kalenderen';
...
Lang.Calendar.LabelUserGroupInfo = 'Hvis du tilordner til brukere er på og et element er dratt på kalenderen enn de timene er automatisk inkludert i beregningen av timer';
Lang.Calendar.LabelCustomDDItemInfo = 'Disse elementene er ikke regnet med i beregningen time fordi det ikke er noen direkte kobling med en bruker. Du kan tilordne til en bruker i redigeringsdialogen etterpå, eller du kan bruke den bruker gruppe DD-elementer ovenfor.';
...
Lang.Calendar.CalendarTitle = 'Kalender tittel';
Lang.Calendar.CalendarLogoOrTitle = 'Viser logoen eller tittel';
